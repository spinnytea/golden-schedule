...
function calculateHeuristic(schedule, startCoords) {
	...
	factors.push(((schedule.number_of_weeks - metrics.maxEarly) / schedule.number_of_weeks) / 2); // minimize early
	factors.push(((schedule.number_of_weeks - metrics.maxLate) / schedule.number_of_weeks) / 2); // minimize late
	factors.push(((schedule.number_of_weeks - metrics.maxSplit) / schedule.number_of_weeks) / 2); // minimize splits
