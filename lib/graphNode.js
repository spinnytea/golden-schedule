...
exports.GraphNode = class GraphNode {
	...
	calculateHeuristic(startCoords) {
		...
		factors.push(schedule.MAX_EARLY - (metrics.maxEarly - metrics.minEarly));
		factors.push(schedule.MAX_LATE - (metrics.maxLate - metrics.minLate));
		factors.push(schedule.MAX_SPLIT - (metrics.maxSplit - metrics.minSplit));
